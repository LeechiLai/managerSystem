    ...
    <el-row :gutter="20">
      ...
      <el-col :span="20" :xs="24">
        ...
        <el-table v-loading="loading" :data="userList" @selection-change="handleSelectionChange">
          ...
          <!--               <el-table-column label="角色" @click="show()" align="center" key="" prop="userId" v-if="columns[6].visible" :show-overflow-tooltip="true" >
                          <template #default="scope">
                          </template>

                         </el-table-column>-->
          <el-table-column label="部门" align="center" key="deptName" prop="dept.deptName" v-if="columns[3].visible" :show-overflow-tooltip="true" />
          <el-table-column label="专业" align="center" key="profession" prop="profession"   v-if="columns[6].visible" :show-overflow-tooltip="true" >
            <template #default="scope">
...
const { sys_normal_disable_profession, user_pro } = proxy.useDict("sys_normal_disable", "user_pro");
...
const data = reactive({
  ...
  rules: {
    ...
    profession: [{ required: true, message: "归属部门不能为空", trigger: "blur" }],
  }
});
